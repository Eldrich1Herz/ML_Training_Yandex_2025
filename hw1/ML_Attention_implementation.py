...
Выполните задания по имплементации Multiplicative и Additive attention, указанные в ноутбуке.
После решения задачи перенесите код соответствующих функций в файл template_p01.py (доступен в репозитории).
